...
public class WriteNewsActivity extends Activity {
	...
	private void setListener() {
		...
		mSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(content)) {
					// 显示提示对话框
					new AlertDialog.Builder(WriteNewsActivity.this)
							.setTitle("开心网")
					...
					// 显示提示信息并关闭当前界面
					Toast.makeText(WriteNewsActivity.this, "上传记录成功",
		...
		mPicture.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(WriteNewsActivity.this, " 跳转到删除图片",
						Toast.LENGTH_SHORT).show();
			}
		});
		mFaceButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 显示表情对话框
				// showFace(mParent);
				Toast.makeText(WriteNewsActivity.this, "显示表情对话框",
						Toast.LENGTH_SHORT).show();
			}
		});
		...
		mPhotoButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mPictureIsExist) {
					Toast.makeText(WriteNewsActivity.this, "最多只能添加一张图片",
							Toast.LENGTH_SHORT).show();
				} else {
					// 图片对话框
					PhotoDialog();
		...
		mAtButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(WriteNewsActivity.this, "暂时不支持@功能",
						Toast.LENGTH_SHORT).show();
			}
		});
	...
	private void init() {
		...
		Toast.makeText(WriteNewsActivity.this, "初始化显示地理位置数据",
				Toast.LENGTH_SHORT).show();
	}
	...
	private void PhotoDialog() {
		AlertDialog.Builder builder = new Builder(WriteNewsActivity.this);
	...
	private class CompetenceAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			ViewHolder holder = null;
			if (convertView == null) {
				convertView = LayoutInflater.from(WriteNewsActivity.this)
